...
z_fpoint_array *z_new_fpoint_array(float maxwidth, float minwidth) {
    z_fpoint_array *a = new z_fpoint_array;
    a->ref = 1;
...
z_fpoint_array *z_fpoint_arraylist_append_new(z_fpoint_arraylist *l, float max, float min) {
    z_fpoint_array *a = z_new_fpoint_array(max, min);
